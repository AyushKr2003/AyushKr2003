...
(function () {
    ...
    const state = {
        theme: localStorage.getItem('ayu_theme') || CONFIG.defaultTheme,
        soundEnabled: localStorage.getItem('ayu_sound_enabled') === 'true',
        matrixActive: false,
        commandHistory: [],
        historyIndex: -1,
        activeFilter: 'all'
    ...
    function applyTheme(themeName) {
        ...
        localStorage.setItem('ayu_theme', themeName);
    ...
    function toggleSound() {
        ...
        localStorage.setItem('ayu_sound_enabled', state.soundEnabled);
    ...
    function setupProjectFilters() {
        ...
        const backendCount = document.querySelectorAll('.project-card[data-category="backend"]').length;
        const flutterCount = document.querySelectorAll('.project-card[data-category="flutter"]').length;
        const ossCount = document.querySelectorAll('.project-card[data-category="opensource"]').length;

        const setVal = (id, val) => { const el = document.getElementById(id); if (el) el.textContent = val; };
        setVal('count-all', allCount);
        setVal('count-backend', backendCount);
        setVal('count-flutter', flutterCount);
        setVal('count-opensource', ossCount);
    }
    ...
    const CLI_COMMANDS = {
        help: {
            ...
            exec: () => `
<span class="term-cyan">AYUSH Virtual Terminal Shell v1.0 (Omarchy / Hyprland)</span>
Available commands:
  ...
  <span class="term-green">experience</span>    Show work experience timeline
  <span class="term-green">education</span>     Show education background
  <span class="term-green">skills</span>        Display engineering capabilities & btop usage
  <span class="term-green">resume</span>        Open resume PDF in a new tab
  ...
  <span class="term-green">echo [text]</span>   Print text back to terminal`
        ...
        whoami: {
            ...
            exec: () => `
<span class="term-green">Ayush Kumar Singh</span> (AyushKr2003)
• Role: Software Engineer · Backend & Flutter Developer
• Stack: Laravel, FastAPI, Flutter, PostgreSQL/MySQL, Linux
• Focus: Production REST APIs, cross-platform mobile apps, AI-integrated platforms
• Open-source: 49+ public repositories, 180+ community GitHub stars
• GitHub: <a href="https://github.com/AyushKr2003" target="_blank" class="term-cyan">https://github.com/AyushKr2003</a>
• Portfolio: <a href="https://main--ayushkrsnghportfolio.netlify.app/" target="_blank" class="term-cyan">ayushkrsnghportfolio.netlify.app</a>`
        },

        fastfetch: {
            desc: 'Run fastfetch system info',
            exec: () => `
<span class="art-green">   __ _____   ____  __ ____ __  </span>  ┌─ System Telemetry ────────────────────────┐
<span class="art-green">  / // / _ \\ / __/ / // __// / </span>  │  User     : Ayush Kumar Singh (AyushKr2003)│
<span class="art-green"> / _  / // /_\\ \\ / _  \\\\ \\/ /  </span>  │  OS       : Omarchy Linux (Arch-based)   │
<span class="art-green">/_//_/\\___/___/ /_//_/ \\_/    </span>  │  Role     : Backend Dev @ Fillip Tech     │
                                  │ 󰅩 Stack    : Laravel, FastAPI, Flutter     │
                                  │  DB       : PostgreSQL, MySQL, SQLite    │
                                  │ 🐚 Shell    : Bash / Zsh                   │
                                  │ 🎓 Education : B.E. CSE, Chandigarh Univ.  │
                                  │  GitHub   : github.com/AyushKr2003       │
                                  └────────────────────────────────────────────┘`
        },
        ...
        projects: {
            ...
            exec: () => `
<span class="term-cyan">~/projects/ (49+ public repositories found)</span>
  🐚 <a href="https://github.com/AyushKr2003/niri-caelestia-shell" target="_blank" class="term-green">niri-caelestia-shell</a>   Desktop shell fork for niri WM — 172★ 21 forks
  🧭 <a href="https://github.com/AyushKr2003/omarchy-overview" target="_blank" class="term-green">omarchy-overview</a>       Live window-preview workspace overview widget — 8★
  🔍 <a href="https://github.com/AyushKr2003/sage_search" target="_blank" class="term-cyan">SageSearch</a>             AI web search & synthesis (Flutter, FastAPI, Gemini, Tavily)
  ...
  ⚙️ <a href="https://github.com/AyushKr2003/shell-settings" target="_blank" class="term-yellow">shell-settings</a>         Shell configuration & plugin utilities — 6★`
        ...
        experience: {
            ...
            exec: () => `
<span class="term-cyan">Work Experience:</span>
  <span class="term-green">Backend Developer</span> — Fillip Technology            Aug 2026 – Present
    RESTful APIs with Laravel/PHP/MySQL, schema design, auth & core business logic

  <span class="term-green">Flutter Developer Intern</span> — Medoc                  Jul 2024 – Jan 2025
    Cross-platform Flutter apps (FDD/MVVM), REST integration, unit testing`
        },

        education: {
            desc: 'Show education background',
            exec: () => `
<span class="term-cyan">Education:</span>
  Bachelor of Engineering, Computer Science Engineering     2022 – 2026
  Chandigarh University, Punjab, India | CGPA: 7.9

  St. Joseph's High School, Patna, India
  12th: 82% (2022) · 10th: 92% (2020)`
        },
...
<span class="term-cyan">Technical Arsenal & Allocation:</span>
  ...
  Backend (Laravel/FastAPI)[████████████████████████████░░░░] 85%
  Linux & Shell Scripting  [████████████████████████████████] 90%
  SQL & Database Design    [██████████████████████████░░░░░░] 80%
  Python & Automation      [████████████████████████░░░░░░░░] 75%
  Blockchain / Solidity    [██████████████████░░░░░░░░░░░░░░] 55%`
        },

        resume: {
            desc: 'Open resume',
            exec: () => {
                window.open('Ayush_Kumar_Singh_Resume.pdf', '_blank');
                return `<span class="term-green">Opening Ayush_Kumar_Singh_Resume.pdf in a new tab...</span>`;
            }
        },
...
<span class="term-cyan">Direct Communication Channels:</span>
  Email    : <a href="mailto:ayushkrsngh2003@gmail.com" class="term-green">ayushkrsngh2003@gmail.com</a>
  Phone    : <span class="term-green">+91 6200695724</span>
  GitHub   : <a href="https://github.com/AyushKr2003" target="_blank" class="term-green">https://github.com/AyushKr2003</a>
  LinkedIn : <a href="https://www.linkedin.com/in/ayush-kumar-singh-8b6b00249/" target="_blank" class="term-green">linkedin.com/in/ayush-kumar-singh</a>
  Website  : <a href="https://main--ayushkrsnghportfolio.netlify.app/" target="_blank" class="term-green">ayushkrsnghportfolio.netlify.app</a>
  Status   : Open for Software Engineer / Backend / Flutter roles`
        },
        ...
        sudo: {
            ...
            exec: () => `<span class="term-red">ayush is not in the sudoers file. This incident will be reported.</span>`
        }
    };
    ...
    function executeCommand(rawCmd) {
        ...
        cmdRow.innerHTML = `<span class="term-cmd-prompt">ayush@omarchy:~$</span><span>${escapeHtml(trimmed)}</span>`;
    ...
    function setupCommandPalette() {
        ...
        const PALETTE_ACTIONS = [
            ...
            { icon: '02', title: 'Browse Projects (Backend, Flutter & Open Source)', action: () => { location.hash = '#projects'; } },
            ...
            { icon: '📋', title: 'Copy Email Address', action: () => { copyToClipboard('ayushkrsngh2003@gmail.com', 'Email copied: ayushkrsngh2003@gmail.com'); } },
            { icon: '📄', title: 'Open Resume PDF', action: () => { window.open('Ayush_Kumar_Singh_Resume.pdf', '_blank'); } },
            { icon: '🐙', title: 'Open GitHub Profile', action: () => { window.open('https://github.com/AyushKr2003', '_blank'); } }
        ];
    ...
    function setupGlobalActions() {
        ...
        document.querySelectorAll('.copy-email-btn').forEach(btn => {
            btn.addEventListener('click', () => {
                const email = btn.getAttribute('data-email') || 'ayushkrsngh2003@gmail.com';
